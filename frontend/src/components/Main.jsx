...
function Main(props) {
    ...
    return(
      ...
      <Grid container item xs={9} sx={{...mainSx, padding: "0", m: "auto", mb: "0.5%"}}>
              ...
              <Grid container item xs={2} sx={{...ratesSx}}>
              ...
              <Grid container item xs sx={{alignItems: "center", justifyContent: "center"}}>
                  <Grid item>
              ...
              <Grid container item xs={2} sx={{alignItems: "center", justifyContent: "center"}}>
                  <Grid item>
